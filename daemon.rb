...
Wonga::Daemon.run(Wonga::Daemon::PantryImportAwsBillCommand.new(AWS::S3.new.buckets[Wonga::Daemon.config['aws']['billing_bucket']], Wonga::Daemon.pantry_api_client, Wonga::Daemon.logger))
